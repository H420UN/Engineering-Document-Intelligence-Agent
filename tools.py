...
def search_engineering_documents(query: str) -> str:
    """
    Search the WSP engineering knowledge base for relevant standards,
...
def generate_structured_report(
    ...
    """
    Compile all findings into a professional WSP-format engineering report.
    ...
    report = f"""
{border}
  WSP  ·  ENGINEERING INTELLIGENCE REPORT
...
{'─'*62}
  Generated by: WSP Engineering Intelligence Agent
  Powered by: Azure OpenAI GPT-4o + LangGraph + Python
  Repository: github.com/[YOUR-GITHUB]/engineering-intelligence-agent
{border}
"""
    return report
